...
class AnalysisInput(BaseModel):
    ...
    phone: Optional[str] = Field(default=None, max_length=2000)
    social: Optional[str] = Field(default=None, max_length=2000)
    dating_profile: Optional[str] = Field(default=None, max_length=2000)
